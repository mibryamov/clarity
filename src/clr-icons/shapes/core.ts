...
export const ClrShapeUnknownStatusSVG = clrIconSVG(`<circle class="clr-i-outline clr-i-outline-path-1" cx="17.58" cy="26.23" r="1.4"/>
...
export const ClrShapeHomeSVG = clrIconSVG(
...
export const ClrShapeCogSVG = clrIconSVG(
...
export const ClrShapeCheckSVG = clrIconSVG(
...
export const ClrShapeTimesSVG = clrIconSVG(
...
export const ClrShapeExclamationTriangleSVG = clrIconSVG(
...
export const ClrShapeExclamationCircleSVG = clrIconSVG(
...
export const ClrShapeCheckCircleSVG = clrIconSVG(
  `<path class="clr-i-outline clr-i-outline-path-1" d="M18,6A12,12,0,1,0,30,18,12,12,0,0,0,18,6Zm0,22A10,10,0,1,1,28,18,10,10,0,0,1,18,28Z"/>
...
export const ClrShapeInfoCircleSVG = clrIconSVG(`<circle class="clr-i-outline clr-i-outline-path-1"  cx="17.93" cy="11.9" r="1.4"/>
...
export const ClrShapeInfoStandardSVG = clrIconSVG(`<circle class="clr-i-outline clr-i-outline-path-1" cx="17.97" cy="10.45" r="1.4"/>
...
export const ClrShapeSuccessStandardSVG = clrIconSVG(
...
export const ClrShapeErrorStandardSVG = clrIconSVG(`<circle class="clr-i-outline clr-i-outline-path-1" cx="18" cy="26.06" r="1.33"/>
...
export const ClrShapeWarningStandardSVG = clrIconSVG(`<circle class="clr-i-outline clr-i-outline-path-1" cx="18" cy="26.06" r="1.33"/>
                <path class="clr-i-outline clr-i-outline-path-2" d="M18,22.61a1,1,0,0,1-1-1v-12a1,1,0,1,1,2,0v12A1,1,0,0,1,18,22.61Z"/>
...
export const ClrShapeHelpInfoSVG = clrIconSVG(
...
export const ClrShapeBarsSVG = clrIconSVG(`<path class="clr-i-outline clr-i-outline-path-1" d="M32,29H4a1,1,0,0,1,0-2H32a1,1,0,0,1,0,2Z"/>
...
export const ClrShapeUserSVG = clrIconSVG(
...
export const ClrShapeAngleSVG = clrIconSVG(
...
export const ClrShapeFolderSVG = clrIconSVG(
...
export const ClrShapeFolderOpenSVG = clrIconSVG(
...
export const ClrShapeBellSVG = clrIconSVG(
...
export const ClrShapeImageSVG = clrIconSVG(
...
export const ClrShapeCloudSVG = clrIconSVG(
...
export const ClrShapeEllipsisHorizontalSVG = clrIconSVG(`<circle cx="31.1" cy="18" r="2.9" class="clr-i-outline clr-i-outline-path-1" />
            ...
            <circle cx="30" cy="6" r="5"  class="clr-i-outline--badged clr-i-outline-path-4--badged clr-i-badge" />`);
export const ClrShapeEllipsisVerticalSVG = clrIconSVG(`<circle cx="18" cy="4.9" r="2.9" class="clr-i-outline clr-i-outline-path-1" />
            <circle cx="18" cy="18" r="2.9" class="clr-i-outline clr-i-outline-path-2" />
            ...
            <circle cx="30" cy="6" r="5"  class="clr-i-outline--badged clr-i-outline-path-4--badged clr-i-badge" />`);
export const ClrShapeFilterGridSVG = clrIconSVG(
...
export const ClrShapeFilterGridCircleSVG = clrIconSVG(
  `<path class="clr-i-outline clr-i-outline-path-1" d="M15,25.86l2,1V20.27a1,1,0,0,0-.29-.7L10.23,13H25.79l-6.47,6.57a1,1,0,0,0-.29.7L19,28l2,1V20.68L27.58,14A1.46,1.46,0,0,0,28,13V12a1,1,0,0,0-1-1H9a1,1,0,0,0-1,1v1a1.46,1.46,0,0,0,.42,1L15,20.68Z"/>
...
export const ClrShapeVmBugSVG = clrIconSVG(
...
export const ClrShapeSearchSVG = clrIconSVG(
...
export const ClrShapeViewColumnsSVG = clrIconSVG(
...
export const ClrShapeAngleDoubleSVG = clrIconSVG(
...
export const ClrShapeCalendarSVG = clrIconSVG(
...
export const ClrShapeEventSVG = clrIconSVG(
...
export const ClrShapeEyeSVG = clrIconSVG(
...
export const ClrShapeEyeHideSVG = clrIconSVG(
...
export const ClrShapeStepForward2SVG = clrIconSVG(
...
export const ClrShapeUnknownStatus = { 'unknown-status': ClrShapeUnknownStatusSVG };
export const ClrShapeHome = { home: ClrShapeHomeSVG };
export const ClrShapeCog = { cog: ClrShapeCogSVG };
export const ClrShapeCheck = { check: ClrShapeCheckSVG };
export const ClrShapeTimes = { times: ClrShapeTimesSVG };
export const ClrShapeExclamationTriangle = { 'exclamation-triangle': ClrShapeExclamationTriangleSVG };
export const ClrShapeExclamationCircle = { 'exclamation-circle': ClrShapeExclamationCircleSVG };
export const ClrShapeCheckCircle = { 'check-circle': ClrShapeCheckCircleSVG };
export const ClrShapeInfoCircle = { 'info-circle': ClrShapeInfoCircleSVG };
export const ClrShapeInfoStandard = { 'info-standard': ClrShapeInfoStandardSVG };
export const ClrShapeSuccessStandard = { 'success-standard': ClrShapeSuccessStandardSVG };
export const ClrShapeErrorStandard = { 'error-standard': ClrShapeErrorStandardSVG };
export const ClrShapeWarningStandard = { 'warning-standard': ClrShapeWarningStandardSVG };
export const ClrShapeHelpInfo = { 'help-info': ClrShapeHelpInfoSVG };
export const ClrShapeBars = { bars: ClrShapeBarsSVG };
export const ClrShapeUser = { user: ClrShapeUserSVG };
export const ClrShapeAngle = { angle: ClrShapeAngleSVG };
export const ClrShapeFolder = { folder: ClrShapeFolderSVG };
export const ClrShapeFolderOpen = { 'folder-open': ClrShapeFolderOpenSVG };
export const ClrShapeBell = { bell: ClrShapeBellSVG };
export const ClrShapeImage = { image: ClrShapeImageSVG };
export const ClrShapeCloud = { cloud: ClrShapeCloudSVG };
export const ClrShapeEllipsisHorizontal = { 'ellipsis-horizontal': ClrShapeEllipsisHorizontalSVG };
export const ClrShapeEllipsisVertical = { 'ellipsis-vertical': ClrShapeEllipsisVerticalSVG };
export const ClrShapeFilterGrid = { 'filter-grid': ClrShapeFilterGridSVG };
export const ClrShapeFilterGridCircle = { 'filter-grid-circle': ClrShapeFilterGridCircleSVG };
export const ClrShapeVmBug = { 'vm-bug': ClrShapeVmBugSVG };
export const ClrShapeSearch = { search: ClrShapeSearchSVG };
export const ClrShapeViewColumns = { 'view-columns': ClrShapeViewColumnsSVG };
export const ClrShapeAngleDouble = { 'angle-double': ClrShapeAngleDoubleSVG };
export const ClrShapeCalendar = { calendar: ClrShapeCalendarSVG };
export const ClrShapeEvent = { event: ClrShapeEventSVG };
export const ClrShapeEye = { eye: ClrShapeEyeSVG };
export const ClrShapeEyeHide = { 'eye-hide': ClrShapeEyeHideSVG };
export const ClrShapeStepForward2 = { 'step-forward-2': ClrShapeStepForward2SVG };

export const CoreShapes: any = {
  ...ClrShapeUnknownStatus,
  ...ClrShapeHome,
  ...ClrShapeCog,
  ...ClrShapeCheck,
  ...ClrShapeTimes,
  ...ClrShapeExclamationTriangle,
  ...ClrShapeExclamationCircle,
  ...ClrShapeCheckCircle,
  ...ClrShapeInfoCircle,
  ...ClrShapeInfoStandard,
  ...ClrShapeSuccessStandard,
  ...ClrShapeErrorStandard,
  ...ClrShapeWarningStandard,
  ...ClrShapeHelpInfo,
  ...ClrShapeBars,
  ...ClrShapeUser,
  ...ClrShapeAngle,
  ...
  ...ClrShapeImage,
  ...ClrShapeCloud,
  ...ClrShapeEllipsisHorizontal,
  ...ClrShapeEllipsisVertical,
  ...ClrShapeFilterGrid,
  ...ClrShapeFilterGridCircle,
  ...ClrShapeVmBug,
  ...ClrShapeSearch,
  ...ClrShapeViewColumns,
  ...ClrShapeAngleDouble,
