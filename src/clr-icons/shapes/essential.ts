...
export const ClrShapeAddTextSVG = clrIconSVG(`<path class="clr-i-outline clr-i-outline-path-1" d="M31,21H13a1,1,0,0,0,0,2H31a1,1,0,0,0,0-2Z"/>
...
export const ClrShapePinboardSVG = clrIconSVG(
...
export const ClrShapeAlarmOffSVG = clrIconSVG(
...
export const ClrShapeNewSVG = clrIconSVG(
...
export const ClrShapeBubbleExclamationSVG = clrIconSVG(
...
export const ClrShapeGridViewSVG = clrIconSVG(
...
export const ClrShapeCursorArrowSVG = clrIconSVG(
...
export const ClrShapeCursorHandSVG = clrIconSVG(
...
export const ClrShapeCursorHandClickSVG = clrIconSVG(
...
export const ClrShapeResizeSVG = clrIconSVG(
...
export const ClrShapeObjectsSVG = clrIconSVG(
...
export const ClrShapeBookSVG = clrIconSVG(`<rect class="clr-i-outline clr-i-outline-path-1" x="10" y="5.2" width="18" height="1.55"/>
...
export const ClrShapeAsteriskSVG = clrIconSVG(
...
export const ClrShapeScissorsSVG = clrIconSVG(`<path class="clr-i-outline clr-i-outline-path-1"
...
export const ClrShapeBugSVG = clrIconSVG(`<circle class="clr-i-outline clr-i-outline-path-1" cx="23.56" cy="17.74" r="1.95"/>
...
export const ClrShapeThermometerSVG = clrIconSVG(`<path class="clr-i-outline clr-i-outline-path-1" d="M19,23.17V11.46H17V23.2a3,3,0,1,0,2,0Z"/>
...
export const ClrShapePencilSVG = clrIconSVG(
...
export const ClrShapeNoteSVG = clrIconSVG(
...
export const ClrShapeRefreshSVG = clrIconSVG(
...
export const ClrShapeSyncSVG = clrIconSVG(
...
export const ClrShapeViewListSVG = clrIconSVG(`<rect class="clr-i-outline clr-i-outline-path-1" x="2" y="8" width="2" height="2"/>
...
export const ClrShapeViewCardsSVG = clrIconSVG(
...
export const ClrShapeLightbulbSVG = clrIconSVG(
...
export const ClrShapeDownloadSVG = clrIconSVG(`<path class="clr-i-outline clr-i-outline-path-1" d="M31,31H5a1,1,0,0,0,0,2H31a1,1,0,0,0,0-2Z"/>
...
export const ClrShapeUploadSVG = clrIconSVG(`<path class="clr-i-outline clr-i-outline-path-1" d="M31,31H5a1,1,0,0,0,0,2H31a1,1,0,0,0,0-2Z"/>
...
export const ClrShapeLockSVG = clrIconSVG(
...
export const ClrShapeUnlockSVG = clrIconSVG(`<path class="clr-i-outline clr-i-outline-path-1" d="M12,25.14V28h2V25.23a2.42,2.42,0,1,0-2-.09Z"/>
...
export const ClrShapeUsersSVG = clrIconSVG(
...
export const ClrShapePopOutSVG = clrIconSVG(
...
export const ClrShapeFilterSVG = clrIconSVG(
...
export const ClrShapePinSVG = clrIconSVG(
...
export const ClrShapeFileSVG = clrIconSVG(
...
export const ClrShapePlusSVG = clrIconSVG(
...
export const ClrShapePlusCircleSVG = clrIconSVG(
...
export const ClrShapeBanSVG = clrIconSVG(
...
export const ClrShapeTimesCircleSVG = clrIconSVG(
...
export const ClrShapeTrashSVG = clrIconSVG(
...
export const ClrShapeCircleSVG = clrIconSVG(
...
export const ClrShapeTagSVG = clrIconSVG(`<circle cx="10.52" cy="10.52" r="1.43" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeTagsSVG = clrIconSVG(
...
export const ClrShapeHistorySVG = clrIconSVG(
...
export const ClrShapeClockSVG = clrIconSVG(
  `<path d="M18,2A16,16,0,1,0,34,18,16,16,0,0,0,18,2Zm0,30A14,14,0,1,1,32,18,14,14,0,0,1,18,32Z" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeAlarmClockSVG = clrIconSVG(
...
export const ClrShapeArrowSVG = clrIconSVG(
...
export const ClrShapeCircleArrowSVG = clrIconSVG(
  `<path d="M18,2A16,16,0,1,0,34,18,16,16,0,0,0,18,2Zm0,30A14,14,0,1,1,32,18,14,14,0,0,1,18,32Z" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeChildArrowSVG = clrIconSVG(
...
export const ClrShapeCopySVG = clrIconSVG(
...
export const ClrShapeHelpSVG = clrIconSVG(
  `<path d="M18,2A16,16,0,1,0,34,18,16,16,0,0,0,18,2Zm0,30A14,14,0,1,1,32,18,14,14,0,0,1,18,32Z" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeLoginSVG = clrIconSVG(
...
export const ClrShapeLogoutSVG = clrIconSVG(
...
export const ClrShapePrinterSVG = clrIconSVG(
...
export const ClrShapeWorldSVG = clrIconSVG(
...
export const ClrShapeSliderSVG = clrIconSVG(
...
export const ClrShapeClipboardSVG = clrIconSVG(
...
export const ClrShapeFirewallSVG = clrIconSVG(
...
export const ClrShapeListSVG = clrIconSVG(`<rect x="15" y="8" width="9" height="2" class="clr-i-outline clr-i-outline-path-1" />
            ...
            <circle cx="30" cy="6" r="5"  class="clr-i-solid--badged clr-i-solid-path-2--badged clr-i-badge" />`);
export const ClrShapeRedoSVG = clrIconSVG(
...
export const ClrShapeUndoSVG = clrIconSVG(
...
export const ClrShapeScrollSVG = clrIconSVG(
...
export const ClrShapeFileSettingsSVG = clrIconSVG(
...
export const ClrShapeTwoWayArrowsSVG = clrIconSVG(
...
export const ClrShapeSwitchSVG = clrIconSVG(
...
export const ClrShapeToolsSVG = clrIconSVG(
...
export const ClrShapeWindowCloseSVG = clrIconSVG(
...
export const ClrShapeWindowMaxSVG = clrIconSVG(
...
export const ClrShapeWindowMinSVG = clrIconSVG(
  `<path d="M27,27H9a1,1,0,0,1,0-2H27a1,1,0,0,1,0,2Z" class="clr-i-outline clr-i-outline-path-1" />`
);
export const ClrShapeWindowRestoreSVG = clrIconSVG(
...
export const ClrShapeZoomInSVG = clrIconSVG(
...
export const ClrShapeLibrarySVG = clrIconSVG(
...
export const ClrShapeBoltSVG = clrIconSVG(
...
export const ClrShapeWrenchSVG = clrIconSVG(
...
export const ClrShapeBullseyeSVG = clrIconSVG(
...
export const ClrShapeTargetSVG = clrIconSVG(
  `<path d="M18,2A16,16,0,1,0,34,18,16,16,0,0,0,18,2Zm0,30A14,14,0,1,1,32,18,14,14,0,0,1,18,32Z" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeFlameSVG = clrIconSVG(
...
export const ClrShapeHourglassSVG = clrIconSVG(
...
export const ClrShapeNoAccessSVG = clrIconSVG(
  `<path d="M18,2A16,16,0,1,0,34,18,16,16,0,0,0,18,2Zm0,30A14,14,0,1,1,32,18,14,14,0,0,1,18,32Z" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeOrganizationSVG = clrIconSVG(
...
export const ClrShapeBalanceSVG = clrIconSVG(`<path d="M24,33H12a1,1,0,0,1,0-2H24a1,1,0,0,1,0,2Z" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeIdBadgeSVG = clrIconSVG(
...
export const ClrShapeRepeatSVG = clrIconSVG(
...
export const ClrShapeFileGroupSVG = clrIconSVG(
...
export const ClrShapePaperclipSVG = clrIconSVG(
...
export const ClrShapeShrinkSVG = clrIconSVG(
...
export const ClrShapeAccessibility1SVG = clrIconSVG(
...
export const ClrShapeAccessibility2SVG = clrIconSVG(
...
export const ClrShapeSortBySVG = clrIconSVG(
...
export const ClrShapeCollapseCardSVG = clrIconSVG(
...
export const ClrShapeExpandCardSVG = clrIconSVG(
...
export const ClrShapeBriefcaseSVG = clrIconSVG(
  `<path d="M32,28a0,0,0,0,1,0,0H4V21.32a7.1,7.1,0,0,1-2-1.43V28a2,2,0,0,0,2,2H32a2,2,0,0,0,2-2V19.89a6.74,6.74,0,0,1-2,1.42Z" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeColorPickerSVG = clrIconSVG(
...
export const ClrShapeCopyToClipboardSVG = clrIconSVG(
  `<path d="M22.6,4H21.55a3.89,3.89,0,0,0-7.31,0H13.4A2.41,2.41,0,0,0,11,6.4V10H25V6.4A2.41,2.41,0,0,0,22.6,4ZM23,8H13V6.25A.25.25,0,0,1,13.25,6h2.69l.12-1.11A1.24,1.24,0,0,1,16.61,4a2,2,0,0,1,3.15,1.18l.09.84h2.9a.25.25,0,0,1,.25.25Z" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeDragHandleSVG = clrIconSVG(
...
export const ClrShapeFilter2SVG = clrIconSVG(`<path d="M33,11H3a1,1,0,0,0,0,2H33a1,1,0,0,0,0-2Z" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeMoonSVG = clrIconSVG(
...
export const ClrShapeSunSVG = clrIconSVG(
  `<path d="M18,6.31a1,1,0,0,0,1-1V1.91a1,1,0,0,0-2,0v3.4A1,1,0,0,0,18,6.31Z" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeWandSVG = clrIconSVG(
...
export const ClrShapeCursorMoveSVG = clrIconSVG(
...
export const ClrShapeCloneSVG = clrIconSVG(
...
export const ClrShapeDetailsSVG = clrIconSVG(
...
export const ClrShapeDragHandleCornerSVG = clrIconSVG(
...
export const ClrShapeEraserSVG = clrIconSVG(
...
export const ClrShapeLandscapeSVG = clrIconSVG(
...
export const ClrShapePasteSVG = clrIconSVG(
...
export const ClrShapePortraitSVG = clrIconSVG(
...
export const ClrShapeTreeViewSVG = clrIconSVG(
...
export const ClrShapeCursorHandGrabSVG = clrIconSVG(
...
export const ClrShapeCursorHandOpenSVG = clrIconSVG(
...
export const ClrShapeFileZipSVG = clrIconSVG(`<path d="M30,30.2V12l-8.1-7.9H7.8C6.8,4.1,6,4.9,6,6c0,0,0,0,0,0v24.2c0,1,0.7,1.8,1.7,1.8c0,0,0.1,0,0.1,0h20.3
...
export const ClrShapeFilterOffSVG = clrIconSVG(`<path d="M34,6.4C34,5.6,33.3,5,32.5,5H10.3l2,2H32v0.6l-9.6,9.6l1.4,1.4L33.4,9C33.8,8.6,34,8.1,34,7.6V6.5C34,6.5,34,6.4,34,6.4z"
...
export const ClrShapeRecycleSVG = clrIconSVG(`<path d="M6.4,17.4c0.2,0.1,0.3,0.1,0.5,0.1c0.2,0,0.4-0.1,0.5-0.1l7-4.1c0.3-0.2,0.5-0.5,0.5-0.9c0-0.4-0.2-0.7-0.5-0.9L11.9,10
...
export const ClrShapeTreeSVG = clrIconSVG(`<path d="M30.6,11.7C29.2,5.8,24,1.7,18,1.7c-7.2,0-13,5.8-13,13c0,6.8,5.3,12.4,12,12.9v5c0,0.6,0.4,1,1,1s1-0.4,1-1v-5v-2V22
...
export const ClrShapeAddText = { 'add-text': ClrShapeAddTextSVG };
export const ClrShapeAlarmOff = { 'alarm-off': ClrShapeAlarmOffSVG };
export const ClrShapePinboard = { pinboard: ClrShapePinboardSVG };
export const ClrShapeNew = { new: ClrShapeNewSVG };
export const ClrShapeBubbleExclamation = { 'bubble-exclamation': ClrShapeBubbleExclamationSVG };
export const ClrShapeGridView = { 'grid-view': ClrShapeGridViewSVG };
export const ClrShapeCursorArrow = { 'cursor-arrow': ClrShapeCursorArrowSVG };
export const ClrShapeCursorHand = { 'cursor-hand': ClrShapeCursorHandSVG };
export const ClrShapeCursorHandClick = { 'cursor-hand-click': ClrShapeCursorHandClickSVG };
export const ClrShapeCursorHandGrab = { 'cursor-hand-grab': ClrShapeCursorHandGrabSVG };
export const ClrShapeCursorHandOpen = { 'cursor-hand-open': ClrShapeCursorHandOpenSVG };
export const ClrShapeCursorMove = { 'cursor-move': ClrShapeCursorMoveSVG };
export const ClrShapeResize = { resize: ClrShapeResizeSVG };
export const ClrShapeObjects = { objects: ClrShapeObjectsSVG };
export const ClrShapeBook = { book: ClrShapeBookSVG };
export const ClrShapeAsterisk = { asterisk: ClrShapeAsteriskSVG };
export const ClrShapeBug = { bug: ClrShapeBugSVG };
export const ClrShapeScissors = { scissors: ClrShapeScissorsSVG };
export const ClrShapeThermometer = { thermometer: ClrShapeThermometerSVG };
export const ClrShapePencil = { pencil: ClrShapePencilSVG };
export const ClrShapeNote = { note: ClrShapeNoteSVG };
export const ClrShapeRefresh = { refresh: ClrShapeRefreshSVG };
export const ClrShapeSync = { sync: ClrShapeSyncSVG };
export const ClrShapeViewList = { 'view-list': ClrShapeViewListSVG };
export const ClrShapeViewCards = { 'view-cards': ClrShapeViewCardsSVG };
export const ClrShapeTreeView = { 'tree-view': ClrShapeTreeViewSVG };
export const ClrShapeLightbulb = { lightbulb: ClrShapeLightbulbSVG };
export const ClrShapeDownload = { download: ClrShapeDownloadSVG };
export const ClrShapeUpload = { upload: ClrShapeUploadSVG };
export const ClrShapeLock = { lock: ClrShapeLockSVG };
export const ClrShapeUnlock = { unlock: ClrShapeUnlockSVG };
export const ClrShapeUsers = { users: ClrShapeUsersSVG };
export const ClrShapePopOut = { 'pop-out': ClrShapePopOutSVG };
export const ClrShapeFilter = { filter: ClrShapeFilterSVG };
export const ClrShapePin = { pin: ClrShapePinSVG };
export const ClrShapeFile = { file: ClrShapeFileSVG };
export const ClrShapePlus = { plus: ClrShapePlusSVG };
export const ClrShapeMinus = { minus: ClrShapeMinusSVG };
export const ClrShapeMinusCircle = { 'minus-circle': ClrShapeMinusCircleSVG };
export const ClrShapePlusCircle = { 'plus-circle': ClrShapePlusCircleSVG };
export const ClrShapeBan = { ban: ClrShapeBanSVG };
export const ClrShapeTimesCircle = { 'times-circle': ClrShapeTimesCircleSVG };
export const ClrShapeTrash = { trash: ClrShapeTrashSVG };
export const ClrShapeCircle = { circle: ClrShapeCircleSVG };
export const ClrShapeTag = { tag: ClrShapeTagSVG };
export const ClrShapeTags = { tags: ClrShapeTagsSVG };
export const ClrShapeHistory = { history: ClrShapeHistorySVG };
export const ClrShapeClock = { clock: ClrShapeClockSVG };
export const ClrShapeAlarmClock = { 'alarm-clock': ClrShapeAlarmClockSVG };
export const ClrShapeArrow = { arrow: ClrShapeArrowSVG };
export const ClrShapeCircleArrow = { 'circle-arrow': ClrShapeCircleArrowSVG };
export const ClrShapeChildArrow = { 'child-arrow': ClrShapeChildArrowSVG };
export const ClrShapeCopy = { copy: ClrShapeCopySVG };
export const ClrShapeHelp = { help: ClrShapeHelpSVG };
export const ClrShapeLogin = { login: ClrShapeLoginSVG };
export const ClrShapeLogout = { logout: ClrShapeLogoutSVG };
export const ClrShapePrinter = { printer: ClrShapePrinterSVG };
export const ClrShapeWorld = { world: ClrShapeWorldSVG };
export const ClrShapeSlider = { slider: ClrShapeSliderSVG };
export const ClrShapeClipboard = { clipboard: ClrShapeClipboardSVG };
export const ClrShapeFirewall = { firewall: ClrShapeFirewallSVG };
export const ClrShapeList = { list: ClrShapeListSVG };
export const ClrShapeRedo = { redo: ClrShapeRedoSVG };
export const ClrShapeUndo = { undo: ClrShapeUndoSVG };
export const ClrShapeScroll = { scroll: ClrShapeScrollSVG };
export const ClrShapeFileSettings = { 'file-settings': ClrShapeFileSettingsSVG };
export const ClrShapeTwoWayArrows = { 'two-way-arrows': ClrShapeTwoWayArrowsSVG };
export const ClrShapeSwitch = { switch: ClrShapeSwitchSVG };
export const ClrShapeTools = { tools: ClrShapeToolsSVG };
export const ClrShapeWindowClose = { 'window-close': ClrShapeWindowCloseSVG };
export const ClrShapeWindowMax = { 'window-max': ClrShapeWindowMaxSVG };
export const ClrShapeWindowMin = { 'window-min': ClrShapeWindowMinSVG };
export const ClrShapeWindowRestore = { 'window-restore': ClrShapeWindowRestoreSVG };
export const ClrShapeZoomIn = { 'zoom-in': ClrShapeZoomInSVG };
export const ClrShapeZoomOut = { 'zoom-out': ClrShapeZoomOutSVG };
export const ClrShapeKey = { key: ClrShapeKeySVG };
export const ClrShapeLibrary = { library: ClrShapeLibrarySVG };
export const ClrShapeBolt = { bolt: ClrShapeBoltSVG };
export const ClrShapeWrench = { wrench: ClrShapeWrenchSVG };
export const ClrShapeBullseye = { bullseye: ClrShapeBullseyeSVG };
export const ClrShapeTarget = { target: ClrShapeTargetSVG };
export const ClrShapeFlame = { flame: ClrShapeFlameSVG };
export const ClrShapeHourglass = { hourglass: ClrShapeHourglassSVG };
export const ClrShapeNoAccess = { 'no-access': ClrShapeNoAccessSVG };
export const ClrShapeOrganization = { organization: ClrShapeOrganizationSVG };
export const ClrShapeBalance = { balance: ClrShapeBalanceSVG };
export const ClrShapeIdBadge = { 'id-badge': ClrShapeIdBadgeSVG };
export const ClrShapeRepeat = { repeat: ClrShapeRepeatSVG };
export const ClrShapeFileGroup = { 'file-group': ClrShapeFileGroupSVG };
export const ClrShapePaperclip = { paperclip: ClrShapePaperclipSVG };
export const ClrShapeShrink = { shrink: ClrShapeShrinkSVG };
export const ClrShapeAccessibility1 = { 'accessibility-1': ClrShapeAccessibility1SVG };
export const ClrShapeAccessibility2 = { 'accessibility-2': ClrShapeAccessibility2SVG };
export const ClrShapeSortBy = { 'sort-by': ClrShapeSortBySVG };
export const ClrShapeCollapseCard = { 'collapse-card': ClrShapeCollapseCardSVG };
export const ClrShapeExpandCard = { 'expand-card': ClrShapeExpandCardSVG };
export const ClrShapeBriefcase = { briefcase: ClrShapeBriefcaseSVG };
export const ClrShapeColorPicker = { 'color-picker': ClrShapeColorPickerSVG };
export const ClrShapeCopyToClipboard = { 'copy-to-clipboard': ClrShapeCopyToClipboardSVG };
export const ClrShapeFilter2 = { 'filter-2': ClrShapeFilter2SVG };
export const ClrShapeDragHandle = { 'drag-handle': ClrShapeDragHandleSVG };
export const ClrShapeMoon = { moon: ClrShapeMoonSVG };
export const ClrShapeSun = { sun: ClrShapeSunSVG };
export const ClrShapeWand = { wand: ClrShapeWandSVG };
export const ClrShapeClone = { clone: ClrShapeCloneSVG };
export const ClrShapeDetails = { details: ClrShapeDetailsSVG };
export const ClrShapeDragHandleCorner = { 'drag-handle-corner': ClrShapeDragHandleCornerSVG };
export const ClrShapeEraser = { eraser: ClrShapeEraserSVG };
export const ClrShapeLandscape = { landscape: ClrShapeLandscapeSVG };
export const ClrShapePaste = { paste: ClrShapePasteSVG };
export const ClrShapePortrait = { portrait: ClrShapePortraitSVG };
export const ClrShapeFileZip = { 'file-zip': ClrShapeFileZipSVG };
export const ClrShapeFilterOff = { 'filter-off': ClrShapeFilterOffSVG };
export const ClrShapeRecycle = { recycle: ClrShapeRecycleSVG };
export const ClrShapeTree = { tree: ClrShapeTreeSVG };
...
export const EssentialShapes: any = {
  ...
  ...ClrShapePinboard,
  ...ClrShapeNew,
  ...ClrShapeBubbleExclamation,
  ...ClrShapeGridView,
  ...ClrShapeCursorArrow,
  ...ClrShapeCursorHand,
  ...ClrShapeCursorHandClick,
  ...ClrShapeCursorHandGrab,
  ...ClrShapeCursorHandOpen,
  ...ClrShapeCursorMove,
  ...ClrShapeResize,
  ...ClrShapeObjects,
  ...ClrShapeBook,
  ...
  ...ClrShapeUndo,
  ...ClrShapeScroll,
  ...ClrShapeFileSettings,
  ...ClrShapeTwoWayArrows,
  ...ClrShapeSwitch,
  ...ClrShapeTools,
  ...ClrShapeWindowClose,
  ...ClrShapeWindowMax,
  ...ClrShapeWindowMin,
  ...ClrShapeWindowRestore,
  ...ClrShapeZoomIn,
  ...ClrShapeZoomOut,
  ...ClrShapeKey,
  ...ClrShapeLibrary,
  ...
  ...ClrShapePaperclip,
  ...ClrShapeShrink,
  ...ClrShapeAccessibility1,
  ...ClrShapeAccessibility2,
  ...ClrShapeSortBy,
  ...ClrShapeCollapseCard,
  ...ClrShapeExpandCard,
  ...ClrShapeBriefcase,
  ...ClrShapeColorPicker,
  ...ClrShapeCopyToClipboard,
  ...ClrShapeFilter2,
  ...ClrShapeDragHandle,
  ...ClrShapeMoon,
  ...ClrShapeSun,
