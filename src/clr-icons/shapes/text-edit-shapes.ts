...
export const ClrShapeBulletList = clrIconSVG(
...
export const ClrShapeCenterText = clrIconSVG(
...
export const ClrShapeCheckboxList = clrIconSVG(
...
export const ClrShapeFontSize = clrIconSVG(
...
export const ClrShapeAlignCenter = clrIconSVG(
...
export const ClrShapeAlignLeft = clrIconSVG(
...
export const ClrShapeAlignRight = clrIconSVG(
...
export const ClrShapeItalic = clrIconSVG(
  `<path d="M24.42,8H17.1a1.1,1.1,0,1,0,0,2.19h2.13L13.11,25.55H10.47a1.1,1.1,0,1,0,0,2.19H17.8a1.1,1.1,0,1,0,0-2.19H15.51l6.13-15.36h2.78a1.1,1.1,0,1,0,0-2.19Z" class="clr-i-outline clr-i-outline-path-1" />`
);
export const ClrShapeJustifyText = clrIconSVG(
...
export const ClrShapeAlignLeftText = clrIconSVG(
...
export const ClrShapeNumberList = clrIconSVG(
...
export const ClrShapePaintRoller = clrIconSVG(
...
export const ClrShapeBlockQuote = clrIconSVG(
...
export const ClrShapeAlignRightText = clrIconSVG(
...
export const ClrShapeText = clrIconSVG(
...
export const ClrShapeUnderline = clrIconSVG(
...
export const ClrShapeAlignBottom = clrIconSVG(
...
export const ClrShapeAlignMiddle = clrIconSVG(
...
export const ClrShapeAlignTop = clrIconSVG(
...
export const ClrShapeLanguage = clrIconSVG(`<path d="M30,3H14v5h2V5h14c0.6,0,1,0.4,1,1v11c0,0.6-0.4,1-1,1H17v7h-5.3L8,27.9V25H5c-0.6,0-1-0.4-1-1V13c0-0.6,0.4-1,1-1h13v-2H5
