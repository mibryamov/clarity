...
import { ClrShapeCalendar, ClrShapeCalendarSVG, ClrShapeEvent } from './core';
import { descriptorConfig } from '../utils/descriptor-config';

/* tslint:disable:variable-name */
export const ClrShapeShareSVG = clrIconSVG(
...
export const ClrShapeStarSVG = clrIconSVG(
...
export const ClrShapeHalfStarSVG = clrIconSVG(
...
export const ClrShapeBookmarkSVG = clrIconSVG(
...
export const ClrShapeEnvelopeSVG = clrIconSVG(
...
export const ClrShapeTasksSVG = clrIconSVG(
...
export const ClrShapeFlagSVG = clrIconSVG(
...
export const ClrShapeInboxSVG = clrIconSVG(
...
export const ClrShapeHeartSVG = clrIconSVG(
...
export const ClrShapeHeartBrokenSVG = clrIconSVG(
...
export const ClrShapeTalkBubblesSVG = clrIconSVG(
...
export const ClrShapeChatBubbleSVG = clrIconSVG(
...
export const ClrShapePictureSVG = clrIconSVG(
...
export const ClrShapeHappyFaceSVG = clrIconSVG(
...
export const ClrShapeNeutralFaceSVG = clrIconSVG(`<path d="M24.05,22.06h-12a1,1,0,0,0,0,2h12a1,1,0,0,0,0-2Z" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeSadFaceSVG = clrIconSVG(
  `<path d="M18,2A16,16,0,1,0,34,18,16,16,0,0,0,18,2Zm0,30A14,14,0,1,1,32,18,14,14,0,0,1,18,32Z" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeThumbsUpSVG = clrIconSVG(
...
export const ClrShapeThumbsDownSVG = clrIconSVG(
...
export const ClrShapeShare = { share: ClrShapeShareSVG };
export const ClrShapeStar = { star: ClrShapeStarSVG };
export const ClrShapeHalfStar = { 'half-star': ClrShapeHalfStarSVG };
export const ClrShapeBookmark = { bookmark: ClrShapeBookmarkSVG };
export const ClrShapeEnvelope = { envelope: ClrShapeEnvelopeSVG };
export const ClrShapeTasks = { tasks: ClrShapeTasksSVG };
export const ClrShapeFlag = { flag: ClrShapeFlagSVG };
export const ClrShapeInbox = { inbox: ClrShapeInboxSVG };
export const ClrShapeHeart = { heart: ClrShapeHeartSVG };
export const ClrShapeHeartBroken = { 'heart-broken': ClrShapeHeartBrokenSVG };
export const ClrShapeTalkBubbles = { 'talk-bubbles': ClrShapeTalkBubblesSVG };
export const ClrShapeChatBubble = { 'chat-bubble': ClrShapeChatBubbleSVG };
export const ClrShapePicture = { picture: ClrShapePictureSVG };
export const ClrShapeHappyFace = { 'happy-face': ClrShapeHappyFaceSVG };
export const ClrShapeNeutralFace = { 'neutral-face': ClrShapeNeutralFaceSVG };
export const ClrShapeSadFace = { 'sad-face': ClrShapeSadFaceSVG };
export const ClrShapeThumbsUp = { 'thumbs-up': ClrShapeThumbsUpSVG };
export const ClrShapeThumbsDown = { 'thumbs-down': ClrShapeThumbsDownSVG };
