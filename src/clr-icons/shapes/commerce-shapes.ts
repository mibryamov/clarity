...
export const ClrShapeCalculatorSVG = clrIconSVG(
...
export const ClrShapeShoppingBagSVG = clrIconSVG(
...
export const ClrShapePiggyBankSVG = clrIconSVG(
...
export const ClrShapeShoppingCartSVG = clrIconSVG(`<circle cx="13.33" cy="29.75" r="2.25" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeWalletSVG = clrIconSVG(
...
export const ClrShapeStoreSVG = clrIconSVG(
...
export const ClrShapeEuroSVG = clrIconSVG(
...
export const ClrShapeDollarSVG = clrIconSVG(
...
export const ClrShapeCreditCardSVG = clrIconSVG(
...
export const ClrShapeBankSVG = clrIconSVG(
...
export const ClrShapeDollarBillSVG = clrIconSVG(
...
export const ClrShapeECheckSVG = clrIconSVG(`<rect class="clr-i-outline clr-i-outline-path-1" x="16" y="16" width="15" height="2"/>
...
export const ClrShapePoundSVG = clrIconSVG(
...
export const ClrShapeRupeeSVG = clrIconSVG(
...
export const ClrShapeWonSVG = clrIconSVG(
...
export const ClrShapeYenSVG = clrIconSVG(
...
export const ClrShapeBitcoinSVG = clrIconSVG(
...
export const ClrShapeCoinBagSVG = clrIconSVG(
...
export const ClrShapePesoSVG = clrIconSVG(
...
export const ClrShapeRubleSVG = clrIconSVG(
...
export const ClrShapeCalculator = { calculator: ClrShapeCalculatorSVG };
export const ClrShapePiggyBank = { 'piggy-bank': ClrShapePiggyBankSVG };
export const ClrShapeShoppingBag = { 'shopping-bag': ClrShapeShoppingBagSVG };
export const ClrShapeShoppingCart = { 'shopping-cart': ClrShapeShoppingCartSVG };
export const ClrShapeWallet = { wallet: ClrShapeWalletSVG };
export const ClrShapeStore = { store: ClrShapeStoreSVG };
export const ClrShapeEuro = { euro: ClrShapeEuroSVG };
export const ClrShapeDollar = { dollar: ClrShapeDollarSVG };
export const ClrShapePeso = { peso: ClrShapePesoSVG };
export const ClrShapeCreditCard = { 'credit-card': ClrShapeCreditCardSVG };
export const ClrShapeBank = { bank: ClrShapeBankSVG };
export const ClrShapeDollarBill = { 'dollar-bill': ClrShapeDollarBillSVG };
export const ClrShapeECheck = { 'e-check': ClrShapeECheckSVG };
export const ClrShapePound = { pound: ClrShapePoundSVG };
export const ClrShapeRupee = { rupee: ClrShapeRupeeSVG };
export const ClrShapeWon = { won: ClrShapeWonSVG };
export const ClrShapeYen = { yen: ClrShapeYenSVG };
export const ClrShapeBitcoin = { bitcoin: ClrShapeBitcoinSVG };
export const ClrShapeRuble = { ruble: ClrShapeRubleSVG };
export const ClrShapeCoinBag = { 'coin-bag': ClrShapeCoinBagSVG };

export const CommerceShapes: any = {
  ...ClrShapeCalculator,
  ...ClrShapePiggyBank,
  ...ClrShapeShoppingBag,
  ...ClrShapeShoppingCart,
  ...ClrShapeWallet,
  ...ClrShapeStore,
  ...ClrShapeEuro,
  ...ClrShapeDollar,
