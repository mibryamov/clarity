...
export const ClrShapeRulerPencilSVG = clrIconSVG(
...
export const ClrShapePhoneHandsetSVG = clrIconSVG(
...
export const ClrShapeNoWifiSVG = clrIconSVG(
...
export const ClrShapeInstallSVG = clrIconSVG(
...
export const ClrShapeUninstallSVG = clrIconSVG(
...
export const ClrShapeLayersSVG = clrIconSVG(
...
export const ClrShapeBlockSVG = clrIconSVG(
...
export const ClrShapeBlocksGroupSVG = clrIconSVG(
...
export const ClrShapeBundleSVG = clrIconSVG(
...
export const ClrShapeWifiSVG = clrIconSVG(
...
export const ClrShapeRackServerSVG = clrIconSVG(`<rect class="clr-i-outline--alerted clr-i-outline-path-1--alerted" x="10" y="17" width="14" height="2"/>
...
export const ClrShapeHardDiskSVG = clrIconSVG(`<rect class="clr-i-outline--alerted clr-i-outline-path-1--alerted" x="6" y="20" width="24" height="2"/>
...
export const ClrShapeBackupRestoreSVG = clrIconSVG(`<rect class="clr-i-outline--alerted clr-i-outline-path-1--alerted" x="6" y="22" width="24" height="2"/>
...
export const ClrShapeBackupSVG = clrIconSVG(`<rect class="clr-i-outline--alerted clr-i-outline-path-1--alerted" x="6" y="22" width="24" height="2"/>
            <rect class="clr-i-outline--alerted clr-i-outline-path-2--alerted" x="26" y="26" width="4" height="2"/>
...
export const ClrShapeDevicesSVG = clrIconSVG(
...
export const ClrShapeKeyboardSVG = clrIconSVG(
...
export const ClrShapeMouseSVG = clrIconSVG(
...
export const ClrShapeDashboardSVG = clrIconSVG(
...
export const ClrShapeHostSVG = clrIconSVG(
...
export const ClrShapeStorageSVG = clrIconSVG(
...
export const ClrShapeClusterSVG = clrIconSVG(
...
export const ClrShapeApplicationsSVG = clrIconSVG(`<polygon points="8 8 4 8 4 10 10 10 10 4 8 4 8 8" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeBuildingSVG = clrIconSVG(
...
export const ClrShapeCPUSVG = clrIconSVG(
...
export const ClrShapeMemorySVG = clrIconSVG(`<rect x="8" y="12" width="4" height="8" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeDataClusterSVG = clrIconSVG(
...
export const ClrShapeResourcePoolSVG = clrIconSVG(
...
export const ClrShapeShieldCheckSVG = clrIconSVG(
...
export const ClrShapeShieldSVG = clrIconSVG(
  `<path d="M31.25,7.4a43.79,43.79,0,0,1-6.62-2.35,45,45,0,0,1-6.08-3.21L18,1.5l-.54.35a45,45,0,0,1-6.08,3.21A43.79,43.79,0,0,1,4.75,7.4L4,7.59v8.34c0,13.39,13.53,18.4,13.66,18.45l.34.12.34-.12c.14,0,13.66-5.05,13.66-18.45V7.59ZM30,15.93c0,11-10,15.61-12,16.43-2-.82-12-5.44-12-16.43V9.14a47.54,47.54,0,0,0,6.18-2.25,48.23,48.23,0,0,0,5.82-3,48.23,48.23,0,0,0,5.82,3A47.54,47.54,0,0,0,30,9.14Z" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeShieldXSVG = clrIconSVG(
  `<path d="M31.25,7.4a43.79,43.79,0,0,1-6.62-2.35,45,45,0,0,1-6.08-3.21L18,1.5l-.54.35a45,45,0,0,1-6.08,3.21A43.79,43.79,0,0,1,4.75,7.4L4,7.59v8.34c0,13.39,13.53,18.4,13.66,18.45l.34.12.34-.12c.14,0,13.66-5.05,13.66-18.45V7.59ZM30,15.93c0,11-10,15.61-12,16.43-2-.82-12-5.44-12-16.43V9.14a47.54,47.54,0,0,0,6.18-2.25,48.23,48.23,0,0,0,5.82-3,48.23,48.23,0,0,0,5.82,3A47.54,47.54,0,0,0,30,9.14Z" class="clr-i-outline clr-i-outline-path-1"/>
...
export const ClrShapeImportSVG = clrIconSVG(
...
export const ClrShapeExportSVG = clrIconSVG(
...
export const ClrShapeUploadCloudSVG = clrIconSVG(
...
export const ClrShapeDownloadCloudSVG = clrIconSVG(
...
export const ClrShapePluginSVG = clrIconSVG(
...
export const ClrShapeFloppySVG = clrIconSVG(
...
export const ClrShapeComputerSVG = clrIconSVG(
...
export const ClrShapeDisplaySVG = clrIconSVG(
...
export const ClrShapeTerminalSVG = clrIconSVG(
...
export const ClrShapeCodeSVG = clrIconSVG(
...
export const ClrShapeApplicationSVG = clrIconSVG(`<rect x="5" y="7" width="2" height="2" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeBatterySVG = clrIconSVG(
...
export const ClrShapeMobileSVG = clrIconSVG(
...
export const ClrShapeTabletSVG = clrIconSVG(`<rect x="17" y="29" width="2" height="2" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeNetworkGlobeSVG = clrIconSVG(`<path d="M26.58,32h-18a1,1,0,1,0,0,2h18a1,1,0,0,0,0-2Z" class="clr-i-outline clr-i-outline-path-1" />
...
export const ClrShapeNetworkSettingsSVG = clrIconSVG(
...
export const ClrShapeNetworkSwitchSVG = clrIconSVG(
...
export const ClrShapeRouterSVG = clrIconSVG(
...
export const ClrShapeVMSVG = clrIconSVG(
...
export const ClrShapeVMWAppSVG = clrIconSVG(
...
export const ClrShapeCertificateSVG = clrIconSVG(
...
export const ClrShapeArchiveSVG = clrIconSVG(
...
export const ClrShapeUnarchiveSVG = clrIconSVG(
  `<path d="M29,32H7V22H5V32a2,2,0,0,0,2,2H29a2,2,0,0,0,2-2V22H29Z" class="clr-i-outline clr-i-outline-path-1" />
            <path d="M14,24a1,1,0,0,0,1,1h6a1,1,0,0,0,0-2H15A1,1,0,0,0,14,24Z" class="clr-i-outline clr-i-outline-path-2" />
...
export const ClrShapeConnectSVG = clrIconSVG(
...
export const ClrShapeDisconnectSVG = clrIconSVG(
...
export const ClrShapeLinkSVG = clrIconSVG(
...
export const ClrShapeUnlinkSVG = clrIconSVG(
...
export const ClrShapeCloudNetworkSVG = clrIconSVG(
...
export const ClrShapeCloudScaleSVG = clrIconSVG(
...
export const ClrShapeCloudTrafficSVG = clrIconSVG(
...
export const ClrShapeDeploySVG = clrIconSVG(
...
export const ClrShapeHelixSVG = clrIconSVG(
...
export const ClrShapeFlaskSVG = clrIconSVG(
...
export const ClrShapeAdministratorSVG = clrIconSVG(
...
export const ClrShapeHardDriveSVG = clrIconSVG(
...
export const ClrShapeHardDriveDisksSVG = clrIconSVG(
...
export const ClrShapeNVMeSVG = clrIconSVG(
...
export const ClrShapeSSDSVG = clrIconSVG(
...
export const ClrShapeBluetoothSVG = clrIconSVG(
...
export const ClrShapeBluetoothOffSVG = clrIconSVG(
...
export const ClrShapeProcessOnVMSVG = clrIconSVG(
...
export const ClrShapeAssignUserSVG = clrIconSVG(
...
export const ClrShapeAtomSVG = clrIconSVG(
...
export const ClrShapeBarCodeSVG = clrIconSVG(
...
export const ClrShapeCdDvdSVG = clrIconSVG(
...
export const ClrShapeContainerSVG = clrIconSVG(
...
export const ClrShapeContainerVolumeSVG = clrIconSVG(
...
export const ClrShapeFileShareSVG = clrIconSVG(
...
export const ClrShapeQrCodeSVG = clrIconSVG(
...
export const ClrShapeUsbSVG = clrIconSVG(
...
export const ClrShapeRadarSVG = clrIconSVG(`<path d="M32,18c0,7.7-6.3,14-14,14c-7.7,0-14-6.3-14-14C4,10.6,9.7,4.5,17.1,4v3.7c-5.7,0.5-9.9,5.5-9.4,11.2s5.5,9.9,11.2,9.4
...
export const ClrShapeRulerPencil = { 'ruler-pencil': ClrShapeRulerPencilSVG };
export const ClrShapePhoneHandset = { 'phone-handset': ClrShapePhoneHandsetSVG };
export const ClrShapeNoWifi = { 'no-wifi': ClrShapeNoWifiSVG };
export const ClrShapeInstall = { install: ClrShapeInstallSVG };
export const ClrShapeUninstall = { uninstall: ClrShapeUninstallSVG };
export const ClrShapeLayers = { layers: ClrShapeLayersSVG };
export const ClrShapeBlock = { block: ClrShapeBlockSVG };
export const ClrShapeBlocksGroup = { 'blocks-group': ClrShapeBlocksGroupSVG };
export const ClrShapeBundle = { bundle: ClrShapeBundleSVG };
export const ClrShapeWifi = { wifi: ClrShapeWifiSVG };
export const ClrShapeRackServer = { 'rack-server': ClrShapeRackServerSVG };
export const ClrShapeHardDisk = { 'hard-disk': ClrShapeHardDiskSVG };
export const ClrShapeBackupRestore = { 'backup-restore': ClrShapeBackupRestoreSVG };
export const ClrShapeBackup = { backup: ClrShapeBackupSVG };
export const ClrShapeDevices = { devices: ClrShapeDevicesSVG };
export const ClrShapeKeyboard = { keyboard: ClrShapeKeyboardSVG };
export const ClrShapeMouse = { mouse: ClrShapeMouseSVG };
export const ClrShapeDashboard = { dashboard: ClrShapeDashboardSVG };
export const ClrShapeHost = { host: ClrShapeHostSVG };
export const ClrShapeStorage = { storage: ClrShapeStorageSVG };
export const ClrShapeCluster = { cluster: ClrShapeClusterSVG };
export const ClrShapeApplications = { applications: ClrShapeApplicationsSVG };
export const ClrShapeBuilding = { building: ClrShapeBuildingSVG };
export const ClrShapeCPU = { cpu: ClrShapeCPUSVG };
export const ClrShapeMemory = { memory: ClrShapeMemorySVG };
export const ClrShapeDataCluster = { 'data-cluster': ClrShapeDataClusterSVG };
export const ClrShapeResourcePool = { 'resource-pool': ClrShapeResourcePoolSVG };
export const ClrShapeShield = { shield: ClrShapeShieldSVG };
export const ClrShapeShieldCheck = { 'shield-check': ClrShapeShieldCheckSVG };
export const ClrShapeShieldX = { 'shield-x': ClrShapeShieldXSVG };
export const ClrShapeImport = { import: ClrShapeImportSVG };
export const ClrShapeExport = { export: ClrShapeExportSVG };
export const ClrShapeUploadCloud = { 'upload-cloud': ClrShapeUploadCloudSVG };
export const ClrShapeDownloadCloud = { 'download-cloud': ClrShapeDownloadCloudSVG };
export const ClrShapePlugin = { plugin: ClrShapePluginSVG };
export const ClrShapeFloppy = { floppy: ClrShapeFloppySVG };
export const ClrShapeComputer = { computer: ClrShapeComputerSVG };
export const ClrShapeDisplay = { display: ClrShapeDisplaySVG };
export const ClrShapeTerminal = { terminal: ClrShapeTerminalSVG };
export const ClrShapeCode = { code: ClrShapeCodeSVG };
export const ClrShapeApplication = { application: ClrShapeApplicationSVG };
export const ClrShapeBattery = { battery: ClrShapeBatterySVG };
export const ClrShapeMobile = { mobile: ClrShapeMobileSVG };
export const ClrShapeTablet = { tablet: ClrShapeTabletSVG };
export const ClrShapeNetworkGlobe = { 'network-globe': ClrShapeNetworkGlobeSVG };
export const ClrShapeNetworkSettings = { 'network-settings': ClrShapeNetworkSettingsSVG };
export const ClrShapeNetworkSwitch = { 'network-switch': ClrShapeNetworkSwitchSVG };
export const ClrShapeRouter = { router: ClrShapeRouterSVG };
export const ClrShapeVM = { vm: ClrShapeVMSVG };
export const ClrShapeVMWApp = { 'vmw-app': ClrShapeVMWAppSVG };
export const ClrShapeCertificate = { certificate: ClrShapeCertificateSVG };
export const ClrShapeArchive = { archive: ClrShapeArchiveSVG };
export const ClrShapeUnarchive = { unarchive: ClrShapeUnarchiveSVG };
export const ClrShapeConnect = { connect: ClrShapeConnectSVG };
export const ClrShapeDisconnect = { disconnect: ClrShapeDisconnectSVG };
export const ClrShapeLink = { link: ClrShapeLinkSVG };
export const ClrShapeUnlink = { unlink: ClrShapeUnlinkSVG };
export const ClrShapeCloudNetwork = { 'cloud-network': ClrShapeCloudNetworkSVG };
export const ClrShapeCloudScale = { 'cloud-scale': ClrShapeCloudScaleSVG };
export const ClrShapeCloudTraffic = { 'cloud-traffic': ClrShapeCloudTrafficSVG };
export const ClrShapeDeploy = { deploy: ClrShapeDeploySVG };
export const ClrShapeHelix = { helix: ClrShapeHelixSVG };
export const ClrShapeFlask = { flask: ClrShapeFlaskSVG };
export const ClrShapeAdministrator = { administrator: ClrShapeAdministratorSVG };
export const ClrShapeHardDrive = { 'hard-drive': ClrShapeHardDriveSVG };
export const ClrShapeHardDriveDisks = { 'hard-drive-disks': ClrShapeHardDriveDisksSVG };
export const ClrShapeNVMe = { nvme: ClrShapeNVMeSVG };
export const ClrShapeSSD = { ssd: ClrShapeSSDSVG };
export const ClrShapeBluetooth = { bluetooth: ClrShapeBluetoothSVG };
export const ClrShapeBluetoothOff = { 'bluetooth-off': ClrShapeBluetoothOffSVG };
export const ClrShapeProcessOnVM = { 'process-on-vm': ClrShapeProcessOnVMSVG };
export const ClrShapeAssignUser = { 'assign-user': ClrShapeAssignUserSVG };
export const ClrShapeAtom = { atom: ClrShapeAtomSVG };
export const ClrShapeBarCode = { 'bar-code': ClrShapeBarCodeSVG };
export const ClrShapeCdDvd = { 'cd-dvd': ClrShapeCdDvdSVG };
export const ClrShapeContainer = { container: ClrShapeContainerSVG };
export const ClrShapeContainerVolume = { 'container-volume': ClrShapeContainerVolumeSVG };
export const ClrShapeFileShare = { 'file-share': ClrShapeFileShareSVG };
export const ClrShapeQrCode = { 'qr-code': ClrShapeQrCodeSVG };
export const ClrShapeUsb = { usb: ClrShapeUsbSVG };
export const ClrShapeRadar = { radar: ClrShapeRadarSVG };

export const TechnologyShapes: any = {
  ...ClrShapeRulerPencil,
  ...ClrShapePhoneHandset,
  ...ClrShapeNoWifi,
  ...ClrShapeInstall,
  ...ClrShapeUninstall,
  ...ClrShapeLayers,
  ...
  ...ClrShapeStorage,
  ...ClrShapeCluster,
  ...ClrShapeApplications,
  ...ClrShapeBuilding,
  ...ClrShapeCPU,
  ...ClrShapeMemory,
  ...ClrShapeDataCluster,
  ...ClrShapeResourcePool,
  ...ClrShapeShield,
  ...ClrShapeShieldCheck,
  ...ClrShapeShieldX,
  ...ClrShapeImport,
  ...
  ...ClrShapeMobile,
  ...ClrShapeTablet,
  ...ClrShapeNetworkGlobe,
  ...ClrShapeNetworkSettings,
  ...ClrShapeNetworkSwitch,
  ...ClrShapeRouter,
  ...ClrShapeVM,
  ...ClrShapeVMWApp,
  ...ClrShapeCertificate,
  ...
  ...ClrShapeLink,
  ...ClrShapeUnlink,
  ...ClrShapeCloudNetwork,
  ...ClrShapeCloudScale,
  ...ClrShapeCloudTraffic,
  ...ClrShapeDeploy,
  ...ClrShapeHelix,
  ...ClrShapeFlask,
  ...ClrShapeAdministrator,
  ...ClrShapeHardDrive,
  ...ClrShapeHardDriveDisks,
  ...ClrShapeNVMe,
  ...ClrShapeSSD,
  ...ClrShapeBluetooth,
  ...ClrShapeBluetoothOff,
  ...ClrShapeProcessOnVM,
  ...ClrShapeAssignUser,
  ...ClrShapeAtom,
  ...ClrShapeBarCode,
