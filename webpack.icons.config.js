...
module.exports = {
  ...
  entry: {
    ...
    'shapes/commerce-shapes-umd': './src/clr-icons/shapes/commerce-shapes-umd.ts',
    'shapes/commerce-shapes-umd.min': './src/clr-icons/shapes/commerce-shapes-umd.ts',
    'shapes/core-shapes': './src/clr-icons/shapes/core-shapes.ts',
    'shapes/core-shapes.min': './src/clr-icons/shapes/core-shapes.ts',
    'shapes/core-shapes-umd': './src/clr-icons/shapes/core-shapes-umd.ts',
    'shapes/core-shapes-umd.min': './src/clr-icons/shapes/core-shapes-umd.ts',
    ...
    'shapes/essential-shapes-umd': './src/clr-icons/shapes/essential-shapes-umd.ts',
    'shapes/essential-shapes-umd.min': './src/clr-icons/shapes/essential-shapes-umd.ts',
    'shapes/media-shapes': './src/clr-icons/shapes/media-shapes.ts',
    'shapes/media-shapes.min': './src/clr-icons/shapes/media-shapes.ts',
    'shapes/media-shapes-umd': './src/clr-icons/shapes/media-shapes-umd.ts',
    'shapes/media-shapes-umd.min': './src/clr-icons/shapes/media-shapes-umd.ts',
    'shapes/social-shapes': './src/clr-icons/shapes/social-shapes.ts',
    'shapes/social-shapes.min': './src/clr-icons/shapes/social-shapes.ts',
    'shapes/social-shapes-umd': './src/clr-icons/shapes/social-shapes-umd.ts',
    'shapes/social-shapes-umd.min': './src/clr-icons/shapes/social-shapes-umd.ts',
    'shapes/travel-shapes': './src/clr-icons/shapes/travel-shapes.ts',
    'shapes/travel-shapes.min': './src/clr-icons/shapes/travel-shapes.ts',
    'shapes/travel-shapes-umd': './src/clr-icons/shapes/travel-shapes-umd.ts',
    'shapes/travel-shapes-umd.min': './src/clr-icons/shapes/travel-shapes-umd.ts',
    ...
    'shapes/technology-shapes-umd': './src/clr-icons/shapes/technology-shapes-umd.ts',
    'shapes/technology-shapes-umd.min': './src/clr-icons/shapes/technology-shapes-umd.ts',
    'shapes/chart-shapes': './src/clr-icons/shapes/chart-shapes.ts',
    'shapes/chart-shapes.min': './src/clr-icons/shapes/chart-shapes.ts',
    'shapes/chart-shapes-umd': './src/clr-icons/shapes/chart-shapes-umd.ts',
    'shapes/chart-shapes-umd.min': './src/clr-icons/shapes/chart-shapes-umd.ts',
    ...
    'shapes/text-edit-shapes-umd': './src/clr-icons/shapes/text-edit-shapes-umd.ts',
    'shapes/text-edit-shapes-umd.min': './src/clr-icons/shapes/text-edit-shapes-umd.ts',
  },
  output: {
